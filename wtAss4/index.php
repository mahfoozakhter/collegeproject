...
<html lang="en">
  <head>
    ...
    <title>WT Assignment 4</title>
  </head>
  <body style="background:url(bg.jpg); background-repeat:no-repeat;background-size:100% 100%" >
  <script src= "jquery-3.5.1.min.js"></script>
    <br /><br />
    <div class="container" style="width:600px;">
        <h2 align="center">JSON - Dropdown List using Jquery and Ajax</h2><br /><br />
    ...
    <div class="tablevent">
        <table class="table">
            <thead>
                ...
                <th scope="col">id</th>
                <th scope="col">shortOrder_name</th>
                ...
                $(document).on('click','#add',function(){
                    ...
                    $.each(value, function (key, val) {
                            ...
                            if (val.name == name && checked=='') {
                                ...
                                var val_id = val.id;
                                var val_sname = val.shortOrder_name;
